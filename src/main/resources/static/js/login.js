function togglePassword() {
    ...
    // 다른 개발자가 나의 코드를 봤을 때 input이 어떤 input인가? email ??? password ??? 인지 알 수 없는 상태
    // 명칭은 다른 개발자가 봤을 때 아~ 이게 이거구나 하고 알 수 있는 명명규칙을 사용 하는 것이 좋다!
    ...
    // ai 같은 경우 이름 단순 추천 XX 명명 규칙은 누구나 확실하게 알 수 있는 명칭으로 작성
